...
function nozama_lite_get_social_networks() {
	return apply_filters(
		...
		array(
			...
			array(
				'name'  => 'tiktok',
				'label' => esc_html__( 'TikTok', 'nozama-lite' ),
				'icon'  => 'fab fa-tiktok',
			),
			array(
				'name'  => 'telegram',
...
function nozama_lite_wp_link_pages_default_args() {
	return apply_filters(
		'nozama_lite_wp_link_pages_default_args',
		array(
...
add_filter( 'stylesheet_uri', 'nozama_lite_stylesheet_uri', 10, 2 );
if ( ! function_exists( 'nozama_lite_stylesheet_uri' ) ) {
	function nozama_lite_stylesheet_uri( $stylesheet_uri, $stylesheet_dir_uri ) {
		if ( ! is_child_theme() ) {
...
if ( ! function_exists( 'nozama_lite_scripts_styles_suffix' ) ) {
	function nozama_lite_scripts_styles_suffix() {
		$suffix = '.min';
		...
		return apply_filters( 'nozama_lite_scripts_styles_suffix', $suffix );
	}
}
